    ...
    <div class="m-4 p-4">  <!--margin, padding-->
        ...
        @csrf
            <div class="col-12 m-2">
                ...
                value="{{ old('company') }}">  <!--전에 작성한 정보 저장을 위해-->
                @error('company')
            ...
            <div class="col-12 m-2">
                ...
                value="{{ old('car_name') }}">  <!--전에 작성한 정보 저장을 위해-->
                @error('car_name')
                <div class="text-red-500">
                    <span>{{ $message }}</span>
                </div>
            ...
            <div class="col-12 m-2">
                ...
                value="{{ old('year') }}">  <!--전에 작성한 정보 저장을 위해-->
                @error('year')
                <div class="text-red-500">
                    <span>{{ $message }}</span>
                </div>
            ...
            <div class="col-12 m-2">
                ...
                value="{{ old('price') }}">  <!--전에 작성한 정보 저장을 위해-->
                @error('price')
                <div class="text-red-500">
                    <span>{{ $message }}</span>
                </div>
            ...
            <div class="col-12 m-2">
                ...
                value="{{ old('car_kind') }}">  <!--전에 작성한 정보 저장을 위해-->
                @error('car_kind')
                <div class="text-red-500">
                    <span>{{ $message }}</span>
                </div>
            ...
            <div class="col-12 m-2">
                ...
                value="{{ old('car_appearnce') }}">  <!--전에 작성한 정보 저장을 위해-->
                @error('title')
                <div class="text-red-500">
                    <span>{{ $message }}</span>
                </div>
